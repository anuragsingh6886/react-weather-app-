...
function App() {
  ...
  const [Search, setSearch] = useState("Mumbai");      // for searching..to api    
    ...
    const fetchApi = async () => {
        const url = `http://api.openweathermap.org/data/2.5/weather?q=${Search}&appid=ddad990b85fe8aef3680c5224f997125&units=metric`
          ...
          <div>
                ...
                <div className="maindiv">
                    <div className="firstdiv">
                        ...
                        <button style={{margin: 2}}onClick={callApi}>
                          Search</button>
                    </div>
                {!City ? (
